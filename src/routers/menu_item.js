...
router.post('/menuItems', auth, permit('Bartender'), upload.single('itemImage'), async (req, res) => {
...
router.patch('/menuItems/:id', auth, permit(''), upload.single('itemImage'), async (req, res) => {
